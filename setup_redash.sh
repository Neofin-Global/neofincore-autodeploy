...
create_config() {
    ...
    echo "REDASH_REDIS_URL=redis://redash_redis:6379/0" >> $REDASH_BASE_PATH/env
...
setup_compose() {
    ...
    sudo docker compose --profile production -f docker-compose.yml run --rm redash-server create_db
